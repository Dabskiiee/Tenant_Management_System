...
$search_term = isset($_POST['search_term']) ? $_POST['search_term'] : '';               // Initialize the search term

if ($search_term != '') {
    $stmt = $admin->runQuery("SELECT * FROM user WHERE fullname LIKE :search_term");            // Modify the SQL query to filter users by username
    $stmt->execute([':search_term' => '%' . $search_term . '%']);
} else {
    $stmt = $admin->runQuery("SELECT * FROM user WHERE usertype = 'user' && status = 'active' ");
    $stmt->execute();
}
        ...
        <div class="main">
            ...
            <main class="content px-3 py-4">
                ...
                <form method="POST" action="" class="search-form">
                    <input type="text" name="search_term" placeholder="Search by username"
                            ...
                            foreach ($user_data as $row) {
                                ...
                                <tr id="<?= $anchor_id ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="tenants_view.php?id=<?= $row['id'] ?>" class="buttons view-btn"><i
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="" style="display:inline;">
                                            ...
                                            <button type="submit" name="remove_user" class="buttons remove-btn"><i
