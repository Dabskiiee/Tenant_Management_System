            ...
            <tbody>
                    ...
                    foreach ($user_data1 as $row1){?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row1['balance']) ?></td>
                            <td><?= htmlspecialchars($row1['electricity']) ?></td>
                            <td><?= htmlspecialchars($row1['water']) ?></td>
                            <td><?= htmlspecialchars($row1['rent']) ?></td>
                            <td><?= htmlspecialchars($row1['wifi']) ?></td>
                            <td><?= htmlspecialchars($row1['unpaid_amt']) ?></td>
                            <td><?= htmlspecialchars($row1['due_date']) ?></td>
            ...
            <tbody>
                    ...
                    foreach ($user_data2 as $row2){?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row2['balance']) ?></td>
                            <td><?= htmlspecialchars($row2['electricity']) ?></td>
                            <td><?= htmlspecialchars($row2['water']) ?></td>
                            <td><?= htmlspecialchars($row2['rent']) ?></td>
                            <td><?= htmlspecialchars($row2['wifi']) ?></td>
                            <td><?= htmlspecialchars($row2['unpaid_amt']) ?></td>
                            <td><?= htmlspecialchars($row2['due_date']) ?></td>
            ...
            <tbody>
                    ...
                    foreach ($user_data3 as $row3){?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row3['balance']) ?></td>
                            <td><?= htmlspecialchars($row3['electricity']) ?></td>
                            <td><?= htmlspecialchars($row3['water']) ?></td>
                            <td><?= htmlspecialchars($row3['rent']) ?></td>
                            <td><?= htmlspecialchars($row3['wifi']) ?></td>
                            <td><?= htmlspecialchars($row3['unpaid_amt']) ?></td>
                            <td><?= htmlspecialchars($row3['due_date']) ?></td>
            ...
            <tbody>
                    ...
                    foreach ($user_data as $row){?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row['electricity']) ?> </td>
                            <td><?= htmlspecialchars($row['water']) ?> </td>
                            <td><?= htmlspecialchars($row['rent']) ?> </td>
                            <td><?= htmlspecialchars($row['wifi']) ?> </td>
